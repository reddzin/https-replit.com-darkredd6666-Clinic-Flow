...
export default function Agendar() {
  ...
  const clinicSlug = params.slug ?? "clinica";
        ...
        <div className="max-w-2xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-tight">{clinicName}</p>
            </div>
          </div>
            ...
            <motion.div key="confirm" initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }}>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Olá, <strong>{name}</strong>! Sua consulta foi agendada com sucesso.
                </p>

                <div className="bg-background border border-border rounded-2xl p-5 text-left mb-6 shadow-sm">
