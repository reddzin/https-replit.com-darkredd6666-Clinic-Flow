...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      >
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1551076805-e1869033e561?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
        ...
        <div className="w-full max-w-[400px]">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/esqueci-a-senha" className="text-sm font-medium text-primary hover:underline">
                        Esqueceu a senha?
                      </Link>
                    </div>
                    <FormControl>
              ...
              />
              <Button type="submit" className="w-full py-6 text-base" data-testid="button-login-submit">
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground">
            Não tem uma conta?{" "}
            <Link href="/cadastro" className="font-medium text-primary hover:underline" data-testid="link-to-cadastro">
