    ...
    <section className="py-24 relative overflow-hidden bg-primary">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-primary-foreground">
          ...
          >
            <Button size="lg" className="h-14 px-8 text-base rounded-full bg-white text-primary hover:bg-white/90 shadow-xl border-0 w-full sm:w-auto" data-testid="button-cta-start">
              Comece seu Teste Grátis
            </Button>
            <Button size="lg" variant="outline" className="h-14 px-8 text-base rounded-full border-white/30 text-white hover:bg-white/10 w-full sm:w-auto bg-transparent" data-testid="button-cta-sales">
              Falar com Consultor
            </Button>
          </motion.div>
        </div>
