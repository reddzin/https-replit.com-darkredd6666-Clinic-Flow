...
import { ArrowRight, Activity, CalendarCheck, ShieldCheck, TrendingUp, Users, Building, CheckCircle2, ChevronRight } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Elevada à Perfeição.</span>
          </motion.h1>
          ...
          >
            <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-base shadow-lg shadow-primary/25 rounded-full" data-testid="button-hero-start">
              Começar Agora
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-8 text-base rounded-full bg-transparent border-primary/20 hover:bg-primary/5" data-testid="button-hero-demo">
